...
function InputBindingVGSetSafe(_forGamepad, _verbIndexA, _binding, _alternateA = 0, _playerIndex = 0)
{
    ...
    {
        var _collisions = InputBindingVGFind(_forGamepad, _verbIndexA, _binding, _playerIndex);
